            ...
            if(move_uploaded_file($_FILES["file"]["tmp_name"], $completePath)){ 
                    ...
                    // Allowed mime types
                        ...
                        if(in_array($_FILES['file']['type'], $csvMimes)){
                            ...
                            $createList = mysqli_query($sqlConnect, "INSERT INTO `My_List` (`name`,`user_id`,`date_created`) VALUES ('$lsitName',$user_id,now() )");
                            ...
                            foreach($csv as $line){
                                ...
                                if (empty($csvl[2])) {
                                    ...
                                    $createEmail = mysqli_query($sqlConnect, "INSERT INTO `My_Email_Lists` (`user_id`, `list_id`, `List_FirstName`, `List_LastName`, `List_Email`, `date_created`) VALUES ($user_id, $listLastInsertId, '$FirstName', '$LastName', '$Email', now() )");
