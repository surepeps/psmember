...
if( isset($_POST['action']) && ($_POST['action'] == "submitPipeLineF") ) {
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if( $access_id == 1 || ($access_id == 2 && $access_remain > 0) ){
            ...
            if($query > 0){
                ...
                $actionTaken = array(
                    'user_id' => $user_id,
                    'page' => $path,
                    'action_description' => "Created New Pipeline With PIPE ID {".$query."}",
                    'action_type' => "insert",
                );
                
                saveUserActions($actionTaken);
                
                $welcomePipeline = filter('welcomePipeline');
                if($welcomePipeline == 1) {
                    createWelcomePipeline($query, $user_id);
                }
           ...
           $data = array(
        		'status' => 401,
        		'message' => 'Sorry You Have exceeded access.',
        	); 
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => $typ,
                'action_description' => "Edited Pipeline With PIPE ID {".$pipe_id."}",
                'action_type' => "update",
            );
            ...
            if($welcomePipeline == 1) {
                createWelcomePipeline($pipe_id, $user_id);
            }
        ...
        if( ($smsRunAllow > 0 && $checkiflcnisavailable != "") || ($smsRunAllow == 0 && $checkiflcnisavailable != "") || ($smsRunAllow == 0 && $checkiflcnisavailable == "") ){
            ...
            if($query){
                ...
                $actionTaken = array(
                    'user_id' => $user_id,
                    'page' => "lead/deal",
                    'action_description' => "Edited Zone for pipeline With PIPE ID {".$pipe_id."}",
                    'action_type' => "update",
                );
        ...
        if( ($smsRunAllow > 0 && $checkiflcnisavailable != "") || ($smsRunAllow == 0 && $checkiflcnisavailable != "") || ($smsRunAllow == 0 && $checkiflcnisavailable == "") ){
            ...
            if($query){
                ...
                $actionTaken = array(
                    'user_id' => $user_id,
                    'page' => "lead/deal",
                    'action_description' => "Edited Market Zone for pipeline With PIPE ID {".$pipe_id."}",
                    'action_type' => "update",
                );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Duplicated pipeline With PIPE ID {".$pipe_id."}",
                'action_type' => "insert",
            );
    ...
    if( $user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted pipeline With PIPE ID {".$pipe_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($s_id){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Created New Stage in pipeline With PIPE ID {".$pipe_id."} And Stage ID of {".$s_id."}",
                'action_type' => "insert",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Fetched Stage Details in pipeline With PIPE ID {".$pipe_id."} And Stage ID of {".$stage_id."}",
                'action_type' => "read",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Fetched Step Details in pipeline With PIPE ID {".$pipe_id."}, Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "read",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated Stage Details in pipeline With PIPE ID {".$pipe_id."} and Stage ID of {".$stage_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated Step Details in pipeline With PIPE ID {".$pipe_id."}, Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Stage Details in pipeline With PIPE ID {".$pipe_id."}, Stage ID of {".$stage_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Step Details in pipeline With PIPE ID {".$pipe_id."} Under Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($step_id){
             ...
             $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Created New Step in pipeline With PIPE ID {".$pipe_id."} Under Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "insert",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($myactionId > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Created New Action in pipeline With PIPE ID {".$pipe_id."} Under Stage ID of {".$stage_id."} Under Step ID of {".$step_id."} and Action ID of {".$myactionId."}",
                'action_type' => "insert",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Email Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated Email Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated SMS Action in pipeline Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted SMS Action in pipeline Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated Wait Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Wait Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "delete",
            );
		...
		if (!empty($_FILES['audio_data']["tmp_name"])) {
			...
			if($update_RVM){
			    ...
			    $actionTaken = array(
                    'user_id' => $user_id,
                    'page' => "lead/deal",
                    'action_description' => "Updated Ringless VoiceMail File in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                    'action_type' => "update",
                );
    ...
    if( $sRVM['audio_type'] != "" || !empty($sRVM['audio_type']) ){
        ...
        if (unlink($aURL)) {
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Ringless VoiceMail File in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Updated Ringless VoiceMail Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($query > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted Ringless VoiceMail Action in pipeline With Step ID of {".$step_id."} and Action ID of {".$action_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($delete){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted ".count($Contsarray)." Contacts From pipeline With PIPE ID of {".$pipe_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($delete){
           ...
           $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Deleted ".count($Contsarray)." Contacts From Contact Table and pipeline With PIPE ID of {".$pipe_id."}",
                'action_type' => "delete",
            );
       ...
       $movcont = MoveContactsInPipeLine($pipe_id,$stage_id,$step_id,$contacts_id);
        ...
        if($movcont){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Moved ".count($Contsarray)." Contacts to pipeline With PIPE ID of {".$pipe_id."} Under Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "insert",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($moveDa > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Moved ".count($Contsarray)." Contacts from pipeline With PIPE ID of {".$pipe_id."} To another PIPE ID of {".$Ppipe_id."} Under Stage ID of {".$stage_id."} and Step ID of {".$step_id."}",
                'action_type' => "insert",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($moveDa > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Tagged ".$moveDa." Contacts in pipeline With Tag ID of {".$tag_id."}",
                'action_type' => "update",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($moveDa > 0){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Removed Tag From ".$moveDa." Contacts in pipeline With Tag ID of {".$tag_id."}",
                'action_type' => "delete",
            );
    ...
    if($user_id === $wo['user']['user_id'] ){
        ...
        if($moveDa){
            ...
            $actionTaken = array(
                'user_id' => $user_id,
                'page' => "lead/deal",
                'action_description' => "Reset Low Wallet Notification In pipeline With PIPE ID of {".$pipe_id."}",
                'action_type' => "update",
            );
