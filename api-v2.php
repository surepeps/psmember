...
if($_REQUEST['testing']==1){$server_key="206d897bbbb66857e4061e73467cff7d";}
...
/*dvm mods added 'send-message','search' on these 2 arrays*/
$pages_without_access_token = array('check-buyers','send-message','search','get-site-settings','active_account_sms','auth', 'regsiter', 'send-reset-password-email', 'create-account', 'social-login','is-active','two-factor');
$pages_without_loggedin = array('check-buyers','send-message','search','get-site-settings','active_account_sms', 'auth', 'regsiter', 'send-reset-password-email', 'create-account', 'social-login','is-active','two-factor');
